"""
Câu 1:
Sư dụng ngôn ngữ lập trinh tùy chọn Python/C++/C#/Java, thư viện thị giác máy tính OpenCV, viêt chương trinh thực hiện yêu câu sau:
Đọc ảnh mầu anh5.jpg vào biến ma trận I.
1. (2 điểm) Hiển thị ảnh I.
2. (4 điểm) Chuyển ảnh sang biểu diễn HSV được ma trận Ihsv. Hiển thị kênh V của Ihsv. Xác định giá trị mức sáng lớn nhất của kênh V của ảnh Ihsv.
3. (1 điểm) Làm trơn ảnh kênh S của Thsv theo bộ lọc trung bình cộng, kích thước cửa số lân cận là 5x5 được ảnh Is. Hiển thị ảnh Is.
4. (1 điểm) Nhị phân hóa ảnh nghịch đảo của ảnh Is (ảnh nghịch đảo là ảnh: Is_2-255-Is) theo ngưỡng Otsu được ảnh nhị phân Ib. Hiển thị ảnh Ib.
5. (1 điểm) Xác định đường contour có diện tích lớn nhất của ảnh Ib. Vẽ đường contour trên ảnh gôc I và hiến thị ảnh I.
6. (1 điêm) Tăng độ sáng của kênh V của ảnh Ihsv băng phương pháp giãn mức xám. Biến đối ngược ảnh Ihsv về biếu diễn mâu RGB được ảnh I. Hiên thị lại ảnh I.
"""
import cv2
import numpy as np
...
# Câu 3: Làm trơn ảnh kênh S của Thsv theo bộ lọc trung bình cộng 5x5
